...
export default function ControlPanel({
  ...
  return (
    <div className={clsx('bg-white border border-slate-200 shadow-md rounded-md py-3', className)}>
      <ColorPalette {...color} className="p-4 border-b border-slate-200" />
      <ToolBox {...tool} className="border-b border-slate-200" />
